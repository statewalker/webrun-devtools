...
Step 1. Install Zipped Extension: [webrun-devtools-extension.zip](https://unpkg.com/@statewalker/webrun-devtools/dist/webrun-devtools-extension.zip)
...
* [How To Use](#how-to-use)
  ...
  * [Step 2: Generate Secure Key](#step-2-generate-secure-key)
...
*Note that these examples will work only if you have the WebRun DevTools extension already installed and activated in your browser*

* [Example 1: Create Screenshot](./examples/01.screenshot.html) ([web: Example 1](https://unpkg.com/@statewalker/webrun-devtools/examples/01.screenshot.html))
* [Example 2: Create Multiple Screenshots](./examples/02.screenshots-many.html) ([web: Example 2](https://unpkg.com/@statewalker/webrun-devtools/examples/02.screenshots-many.html)) 
* [Example 3: Multiple Screenshots with Crhome Debugger API](./examples/03.screenshots-debugger.html) ([web: Example 3](https://unpkg.com/@statewalker/webrun-devtools/examples/03.screenshots-debugger.html)) 
...
2. [Generate Secure Key](#step-2-generate-secure-key): Get a secure key generated by the extension to access internal browser APIs. This key stays within your browser for enhanced security.
...
1. *Download the Extension:* Download the prepared extension from NPM and unzip it in a separate folder. Note: see how to build the extension from sources in the section [Build From Sources]( #build-from-sources )
  - [unpkg: webrun-devtools-extension.zip](https://unpkg.com/@statewalker/webrun-devtools/dist/webrun-devtools-extension.zip)
